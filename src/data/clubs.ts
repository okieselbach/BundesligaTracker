...
export const CLUBS_2BL: Club[] = [
  ...
  { id: "club_d98", name: "SV Darmstadt 98", shortName: "D98", slug: "sv-darmstadt-98", primaryColor: "#004E9E", secondaryColor: "#FFFFFF", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/e/e0/SV_Darmstadt_98_logo.svg" },
  { id: "club_els", name: "SV Elversberg", shortName: "SVE", slug: "sv-elversberg", primaryColor: "#009639", secondaryColor: "#FFFFFF", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/1/1e/SV_07_Elversberg_Logo.svg" },
  ...
  { id: "club_bie", name: "Arminia Bielefeld", shortName: "DSC", slug: "dsc-arminia-bielefeld", primaryColor: "#004B87", secondaryColor: "#FFFFFF", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/a/ab/Arminia-wappen-2021.svg" },
  { id: "club_ksc", name: "Karlsruher SC", shortName: "KSC", slug: "karlsruher-sc", primaryColor: "#003DA5", secondaryColor: "#FFFFFF", logoUrl: "https://upload.wikimedia.org/wikipedia/en/d/d6/Karlsruher_SC_logo.svg" },
  ...
  { id: "club_bra", name: "Eintracht Braunschweig", shortName: "EBS", slug: "eintracht-braunschweig", primaryColor: "#FFD700", secondaryColor: "#0000FF", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/c/c2/Eintracht_Braunschweig_Logo.svg" },
  ...
  { id: "club_pce", name: "Preußen Münster", shortName: "SCM", slug: "sc-preussen-muenster", primaryColor: "#006A3A", secondaryColor: "#FFFFFF", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/5/5e/SC_Preussen_M%C3%BCnster_Logo.svg" },
  { id: "club_fcm", name: "1. FC Magdeburg", shortName: "FCM", slug: "1-fc-magdeburg", primaryColor: "#0066B3", secondaryColor: "#FFFFFF", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/b/b3/1._FC_Magdeburg.svg" },
  { id: "club_sgd", name: "SG Dynamo Dresden", shortName: "SGD", slug: "sg-dynamo-dresden", primaryColor: "#FFCC00", secondaryColor: "#000000", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/2/2f/SG_Dynamo_Dresden_Logo.svg" },
  { id: "club_gre", name: "SpVgg Greuther Fürth", shortName: "SGF", slug: "spvgg-greuther-fuerth", primaryColor: "#006B3F", secondaryColor: "#FFFFFF", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/d/d7/SpVgg_Greuther_F%C3%BCrth_2017.svg" },
];
...
export const CLUBS_3BL: Club[] = [
  ...
  { id: "club_hav", name: "TSV Havelse", shortName: "HAV", slug: "tsv-havelse", primaryColor: "#003DA5", secondaryColor: "#FFFFFF", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/3/3c/TSV_Havelse_Logo.svg" },
  { id: "club_swf", name: "1. FC Schweinfurt 05", shortName: "SWF", slug: "schweinfurt-05", primaryColor: "#006B3F", secondaryColor: "#FFD700", logoUrl: "https://upload.wikimedia.org/wikipedia/commons/9/9b/Logo_1._FC_Schweinfurt_05.svg" },
];
